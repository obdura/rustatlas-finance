...
impl IndexFxCashflow {
    ...
    pub fn with_discount_curve_id(mut self, id: usize) -> IndexFxCashflow {
    ...
    pub fn set_fixing_fx(&mut self, fixing_fx: f64) {
        self.fixing_fx = Some(fixing_fx);
        self.cashflow.set_amount(self.reference_notional() * fixing_fx);
    }
}

impl Payable for IndexFxCashflow {
...
impl HasCurrency for IndexFxCashflow {
    fn currency(&self) -> Result<Currency> {
        self.cashflow.currency()
    }
}

impl HasDiscountCurveId for IndexFxCashflow {
    fn discount_curve_id(&self) -> Result<usize> {
        self.cashflow.discount_curve_id()
    }
}

impl HasForecastCurveId for IndexFxCashflow {
...
impl Registrable for IndexFxCashflow {
...
impl Expires for IndexFxCashflow {
    fn is_expired(&self, date: Date) -> bool {
        self.cashflow.payment_date() < date
    }
}

impl Scalable for IndexFxCashflow {
